...
\label{The thesis}
\newcommand{\PhDTitleFR}{Computational protein design: a tool for protein engineering and synthetic biology} %% Titre en Français
\newcommand{\PhDkeywordsFR}{CPD, simulation, Monte Carlo, PDZ} %% 3 à 6 mots clefs
\newcommand{\PhDsumFR}{Proteus sur PDZ} %% Résumé


\newcommand{\PhDTitleEN}{Computational protein design: a tool for protein engineering and synthetic biology} %% Title
\newcommand{\PhDkeywordsEN}{CPD, simulation, Monte Carlo, PDZ} %% 3-6 Keywords
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 ...
 \label{Personnal}
\newcommand{\PhDname}{M. David Mignon} % Civility, first name and name 
\newcommand{\NNT}{201XSACLSXXX} %% Your NNT numer (the Library will attribute one...)
\newcommand{\ecodocnum}{XXX} % Accrediation number
\newcommand{\ecodoctitle}{INTERFACES: approches interdisciplinaires, fondements,applications et innovation} % Full name of the doctorale school
\newcommand{\PhDspeciality}{Les sciences du vivant} % Speciality 
\newcommand{\PhDworkingplace}{École Polytechnique} %PhD working place (must be one of these : Université Paris-Sud, Université de Versailles Saint Quentin, Université d’Evry, AgroParisTech, CentraleSupelec, Ecole Normale Supérieure de Cachan, Ecole Polytechnique, ENSTA ParisTech,ENSAE ParisTech, HEC,Institut d’Optique Graduate School,Telecom ParisTech or Telecom SudParis)
\newcommand{\defenseplace}{"lieu"} %Place of defense
\newcommand{\defensedate}{XX mois 201X} % Date of defense
\newcommand{\logoED}{\includegraphics[scale=1.2]{logo/EDI.jpg}} % Logo of doctoral school. Check the name of the correct file in the /logo folder.
\newcommand{\logoEt}{\includegraphics[scale=1.2]{logo/X.png}} % Must be the logo corresponding to %PhD working place. Check the name of the correct file in the /logo folder.
...
\newcommand{\jurynameF}{Thomas Simonson}
\newcommand{\jurygenderF}{M.} % M. or Mme. / Mrs.
\newcommand{\juryadressF}{\'Ecole Polytechnique}
