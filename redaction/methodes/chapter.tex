...
L'utilisateur a la possibilité de définir des groupes sur le système étudier. Un groupe est associé à une partie du système. Il se définit en donnant la liste des positions qu'il contient dans la balise <Group\_Definition> du fichier de configuration. Par exemple:

\textttt{<Group\_Definition>}
\textttt{grp_1 1−3}
\textttt{grp_2 4 5}
\textttt{grp_3 6-8}
\textttt{</Group\_Definition>}
...
\textttt{<Space_Constraints>}
\textttt{grp_4.TYPE grp3}
\textttt{</Space_Constraints>}

Dans l'exemple précédent le groupe \textttt{grp_4} représente une seconde conformation-séquence des résidus compris entre les numéros 6 et 8 du fichier backbone. La déclaration dans la balise  <Space\_Constraints> garantie que les groupes \textttt{grp_3} et \textttt{grp_4} auront des séquences identiques tout au long de l'exploration. 
