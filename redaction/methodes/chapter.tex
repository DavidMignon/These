...
Le calcul de la matrice d'énergie est exécuté à l'aide du programme X-plor \cite{Xplor}. À partir d'un fichier PDB, une série de scripts X-plor commence par préparer le système. Il peut contenir un ligand. Le déroulement est le suivant:
