...
Il est possible de limiter l'impression à un seul modèle \verb!i! par une commande du type:\\
...
Le système de déplacements expliqué en \vref{sub:MC_move}  souffre de certaines rigidités. Il ne permet pas de distribuer les modifications selon les positions dans la chaîne polypeptidique. Il n'est pas possible de répartir alternativement les mouvements entre mutations et changement de rotamères.
