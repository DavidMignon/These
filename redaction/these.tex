...
%%\usepackage{lmodern}
\usepackage[authoryear,square,colon,compress]{natbib}
...
% lists gérées hors de frenchb
\frenchbsetup{StandardLists=true}
\pdfcompresslevel=9
\hypersetup{%
  pdftitle={Computational protein design: un outil pour l’ingénierie des protéines et la biologie synthétique}, 
...
{\LARGE \bf \@title\\}
\vfill
{\LARGE \bf Computational protein design: un outil pour l’ingénierie des protéines et la biologie synthétique\\}
\vspace{4ex}
...
\begin{center}  
\begin{tabular}{lll}
Rapporteurs :       & Pr. Jean-François \bsc{Gibrat} \\
                    & Pr. Yves-Henri \bsc{Sanojouand}\\
                    & &\\
Examinateurs :      & Dr. Sophie \bsc{Barbe} \\
                    & Dr. Julien \bsc{Bigot} \\
                    & Pr. Alain  \bsc{Denise} \\
Directeur de thèse: & Pr. Thomas \bsc{Simonson} \\
\end{tabular}
\end{center}
\end{small}
\vfill
...
\hrule
\vspace{2ex}
{\footnotesize \bf Laboratoire de Biochimie de l' \'Ecole Polytechnique}
\end{center}
\newpage
...
\graphicspath{{./Couverture}{./PDZ/}{./PDZ/graphes/}{./CPD/}{./CPD/figure/}{./comparaisons/figure/}{./methodes/}{./developpements/}}

\include{CPD/chapter}
\clearplaindoublepage{}
\include{methodes/chapter}
\clearplaindoublepage{}
\include{annexe_proteus}
\include{annexe_groupes}
\clearplaindoublepage{}
\include{developpements/chapter}
\clearplaindoublepage{}
