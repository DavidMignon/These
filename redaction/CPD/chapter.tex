...
Une chaîne de Markov est irréductible si et seulement si son graphe est fortement connexe, i.e. si pour tout couple   i ≠ j   {\displaystyle \scriptstyle \ i\neq j\ } \scriptstyle \ i\neq j\ de sommets du graphe il existe un chemin de   i   {\displaystyle \scriptstyle \ i\ } \scriptstyle \ i\ à   j   {\displaystyle \scriptstyle \ j\ } \scriptstyle \ j\ et un chemin de   j   {\displaystyle \scriptstyle \ j\ } \scriptstyle \ j\ à   i . {\displaystyle \scriptstyle \ i.} \scriptstyle \ i.
