...
Les résultats sont visibles à la table \ref{tab:Traj_ident}.L'effet du doublement de la longueur de la trajectoire existe mais est très faible. De même l'augmentation du nombre de trajectoires, pourtant drastique, n'apporte quasiment rien. Élément intéressant, à nombre de pas identique, il n'y pas de différence notable entre le protocole mille trajectoire et celui à une seule.  
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1ABO_simil_bypos.pdf} &
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1BM2_simil_bypos.pdf} \\
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1CKA_simil_bypos.pdf} &
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1G9O_simil_bypos.pdf} \\
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1M61_simil_bypos.pdf} &
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1O4C_simil_bypos.pdf} \\
       \includegraphics[trim=0cm 8cm 0cm 6cm,clip,width=8.5cm]{1R6J_simil_bypos.pdf} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_p3_simil_bypos.jpg}  &
       \includegraphics[width=8.45cm]{1BM2_p3_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1CKA_p3_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1G9O_p3_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1M61_p3_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1O4C_p3_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1R6J_p3_simil_bypos.jpg} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_p4_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1BM2_p4_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1CKA_p4_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1G9O_p4_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1M61_p4_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1O4C_p4_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1R6J_p4_simil_bypos.jpg} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_ph_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1BM2_ph_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1CKA_ph_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1G9O_ph_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1M61_ph_simil_bypos.jpg} &
       \includegraphics[width=8.45cm]{1O4C_ph_simil_bypos.jpg} \\
       \includegraphics[width=8.45cm]{1R6J_ph_simil_bypos.jpg} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_p3_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1BM2_p3_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1CKA_p3_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1G9O_p3_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1M61_p3_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1O4C_p3_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1R6J_p3_simil_byseq_frequency.eps} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_p4_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1BM2_p4_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1CKA_p4_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1G9O_p4_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1M61_p4_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1O4C_p4_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1R6J_p4_simil_byseq_frequency.eps} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_ph_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1BM2_ph_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1CKA_ph_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1G9O_ph_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1M61_ph_simil_byseq_frequency.eps} &
       \includegraphics[width=8.45cm]{1O4C_ph_simil_byseq_frequency.eps} \\
       \includegraphics[width=8.45cm]{1R6J_ph_simil_byseq_frequency.eps} \\
     \end{tabular}
   ...
   \begin{figure}[t]
     \centering
     \begin{tabular}{cc}
       \includegraphics[width=8.45cm]{1ABO_centiles.png} &
       \includegraphics[width=8.45cm]{1BM2_centiles.png} \\
       \includegraphics[width=8.45cm]{1CKA_centiles.png} &
       \includegraphics[width=8.45cm]{1G9O_centiles.png} \\
       \includegraphics[width=8.45cm]{1M61_centiles.png} &
       \includegraphics[width=8.45cm]{1O4C_centiles.png} \\
       \includegraphics[width=8.45cm]{1R6J_centiles.png} \\
     \end{tabular}
