...
Les paramétrages utilisés pour le programme toulbar2.

Premier protocole toulbar2 version : 0.9.7.0 avec les options suivantes  -l=3 -m -d: -s, ce qui correspond au paramètrage conseillé dans la documentation CPD. 

Après disc

Le second protocole utilise la version : 0.9.6.0 du programme.

toulbar2 MATRIX.wcsp -l=1 -dee=1 -m -d: -s 
