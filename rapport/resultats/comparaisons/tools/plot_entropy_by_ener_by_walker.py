...
try:
    ...
    RE_T6_data   = sys.argv[7]
    RE_T7_data   = sys.argv[8]
    RE_T8_data   = sys.argv[9]
    toulbar2_data   = sys.argv[10]
    output_file  = sys.argv[11]

except:
    print "usage: \n" + sys.argv[0] + " protein_name RE_T1_data  RE_T2_data RE_T3_data RE_T4_data RE_T5_data RE_T6_data RE_T7_data RE_T8_data RE_T9_data toulbar2_data graph_name.png \n"
    sys.exit(2)
...
entropies6 = np.loadtxt(RE_T6_data,usecols=[0])
ener6      = np.loadtxt(RE_T6_data,usecols=[2])

entropies7 = np.loadtxt(RE_T7_data,usecols=[0])
ener7      = np.loadtxt(RE_T7_data,usecols=[2])

entropies8 = np.loadtxt(RE_T8_data,usecols=[0])
ener8      = np.loadtxt(RE_T8_data,usecols=[2])
...
ax.plot(ener1,entropies1, color='green'  ,marker='o' , label="T=3")
ax.plot(ener2,entropies2, color='red'    ,marker='o' , label="T=2")
ax.plot(ener3,entropies3, color='blue'   ,marker='o' , label="T=1.333")
ax.plot(ener4,entropies4, color='black'  ,marker='o' , label="T=0.888")
ax.plot(ener5,entropies5, color='magenta',marker='o' , label="T=0.592")
ax.plot(ener6,entropies6, color='green'  ,marker='o' , label="T=0.395")
ax.plot(ener7,entropies7, color='red'    ,marker='o' , label="T=0.263")
ax.plot(ener8,entropies8, color='black'  ,marker='o' , label="T=0.175")
