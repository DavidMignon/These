...
$E_{MM}$ représente l'énergie interne de la protéine se compose de six termes, ils sont détaillés en \ref{sub:mecamol}. 
...
\item Cette stratégie rend le modèle moins sensible aux variations de la longueur des boucles de surface et au ratio  de nombre de résidus de surface sur  celui des enterrés, qui peut varier considérablement selon les homologues (voir plus bas).  
\end{itemize}
